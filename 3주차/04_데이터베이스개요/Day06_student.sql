...
-- 커밋(COMMIT;) : 수정, 삭제, 갱신 등 작업이 완료되면 DB에 최종 반영
...
-- 하나씩 입력할 떄는 Default 필드(컬럼)은 생략해도 됨
-- INSERT INTO professor VALUES ('P004', '최지우', 'jiwoo@school.ac.kr', 'CSE', 2020);

-- 대량으로 입력할떄는 Default 필드라도 반드시 추가
...
INSERT INTO student (name, birth_year, dept_id, grade)
VALUES ('정상학생', 2002, 'CSE', 4);
-- ============================================================
